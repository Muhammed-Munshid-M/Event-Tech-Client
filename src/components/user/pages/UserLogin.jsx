                        ...
                        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0  bg-slate-950">
                            ...
                            <div className="w-full py-6 z-20">
                                ...
                                <form onSubmit={verifyLogin} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                                    ...
                                    <div className="pb-2 pt-4">
                                        <input type="password" name="password" id="password" placeholder="Password" value={password} className="block w-full p-4 text-lg rounded-sm bg-black"
                                    ...
                                    <button className="block w-full p-4 text-lg rounded-full bg-slate-300 hover:bg-slate-200 focus:outline-none text-black">
                                        <img className='absolute w-6' src="https://tailus.io/sources/blocks/social/preview/images/google.svg" alt="" /><span className='ps-5'>
